...
public class MouseLook : MonoBehaviour 
{
	...
	[SerializeField] CrossHair c_CrossHair;
	...
	float sightDistance = 11.0f; // overall view (dont want too far so we dont have to make as many calc)
	float enemySight = 10.0f;
	float allySight = 10.0f;
	float objectSight = 10.0f;
