...
public class CharacterMotor : MonoBehaviour
{
    ...
    public class CharacterMotorMovement
    {
        ...
        public float maxSidewaysSpeed = 1.0f;
        public float maxBackwardsSpeed = 0.5f;

        // How fast does the character change speeds?  Higher is faster.
        public float maxGroundAcceleration = 3.0f;
	...
	IEnumerator SetSpeedMultiplier ()
	{
		...
		movement.maxForwardSpeed *= mult;
		movement.maxSidewaysSpeed *= mult2;
		movement.maxBackwardsSpeed *= mult;
		movement.maxGroundAcceleration *= mult;
		
		movement.maxAirAcceleration *= mult;
		movement.gravity *= mult;
		movement.maxFallSpeed *= mult;
		*/
