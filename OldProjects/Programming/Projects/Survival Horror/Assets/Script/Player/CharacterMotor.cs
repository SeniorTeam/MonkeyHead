...
public class CharacterMotor : MonoBehaviour
{
	...
	{
		movement.maxForwardSpeed *= 400;
		movement.maxSidewaysSpeed *= 400;
		movement.maxBackwardsSpeed *= 400;
		movement.maxGroundAcceleration *= 400;
		
		movement.maxAirAcceleration *= 400;
		movement.gravity *= 400;
		movement.maxFallSpeed *= 400;
	}
